...
hook-chapter/
├── README.md       ← 本文件
├── chapter.tsx     ← 完整章節示例 —— 默認綁 newsroom 主題
└── chapter.css
```
...
- `bauhaus-bold` → brush 劃掉換 hard-cut 大色塊；hero 字體換 Archivo Black
